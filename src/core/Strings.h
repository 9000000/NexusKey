...
enum class StringId : uint16_t {
    ...
    SPELL_ADVANCED_DOWNLOAD_PROMPT,
    SPELL_ADVANCED_DOWNLOADING,
    SPELL_ADVANCED_NETWORK_FAILED,
    SPELL_ADVANCED_VERIFY_FAILED,
    SPELL_ADVANCED_INSTALL_FAILED,
    SPELL_ADVANCED_CLOSE_APP,
    MACRO_CONFIRM_DELETE,
    MACRO_CONFIRM_DELETE_MULTI,
